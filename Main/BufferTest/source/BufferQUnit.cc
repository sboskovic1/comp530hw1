...
int main () {
	...
	// UNIT TEST 1: A BIG ONE!!
	{
        ...
        cout << myMgr.freePages.size() << " free pages after unpinning 10 pages" << endl;
...
//     {
//         std::cout << "Starting Buffer Manager Unit Test" << std::endl;

// 		MyDB_BufferManager myMgr (64, 4, "tempDSFSD");

//         std::cout << "Created Buffer Manager" << std::endl;
...
// 		// look up all of the pages, and make sure they have the correct numbers
//         MyDB_PageHandle * handles = new MyDB_PageHandle[5];
...
//         std::cout << "Printing Buffer State" << std::endl;

//         myMgr.printBuffer();

//         std::cout << "Printing Handles" << std::endl;
